      ...
      return (
        <div className="projects-grid">
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              This is my first attempt at a contact keeping application using
              React js.
            </CardText>
            <CardActions border>
              <Button
                href="https://github.com/Dylanmeyer/Contact_Keeper"
                target="_blank"
              >
                GitHub
              </Button>
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              This is an IT-Logger application using React js.
            </CardText>
            <CardActions border>
              <Button
                href="https://github.com/Dylanmeyer/IT-Logger"
                target="_blank"
              >
                GitHub
              </Button>
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              This is my portfolio (Digital CV) application using React js.
            </CardText>
            <CardActions border>
              <Button
                href="https://github.com/Dylanmeyer/portfolio"
                target="_blank"
              >
                GitHub
              </Button>
      ...
      return (
        <div className="projects-grid">
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              A lotto task which prints a receipt and shows how much you have
              won.
            </CardText>
            <CardActions border>
              <Button
                href="https://github.com/Dylanmeyer/Lotto-task"
                target="_blank"
              >
                GitHub
              </Button>
      ...
      return (
        <div className="projects-grid">
          ...
          <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
            ...
            ></CardTitle>
            <CardText>
              My First user profile webpage using HTML and Css.
            </CardText>
            <CardActions border>
              <Button
                href="https://github.com/Dylanmeyer/UserProfileWebpage"
                target="_blank"
              >
                GitHub
              </Button>
